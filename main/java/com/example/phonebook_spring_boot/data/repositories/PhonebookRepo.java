...
public interface PhonebookRepo {
	...
	Optional<Phonebook> findPhonebookById(Long id) throws DatabaseConnectionFailedException, PhonebookDoesNotExistException;
	...
	void deletePhonebookById(Long id) throws DatabaseConnectionFailedException, PhonebookDoesNotExistException;
